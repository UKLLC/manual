...
**Example - first data deposit - File 2 documentation (EXCEED_file2documentation_v0001_20211002)**  
...
File 2 updates are only required in the following scenarios:  
* Corrections have been made to a File 2, e.g. de-duplications when an LPS becomes aware that a participant has been enrolled in an LPS twice, and a correction is made to the File 2
* New records have been added to a File 2, e.g. LPS with ongoing recruitment
* Structural changes to a dataset, e.g. the addition of new variable(s). 
...
| 20211002 | covidw1_data_v0001_20211002 | | SPSS |
| 20211002 | covidw2_data_v0001_20211002 | | SPSS |
| <strong>20211119 | <strong>Covidw3_data_v0001_20211119 | | <strong>SPSS |
| <strong>20211119 | <strong>Covidw1_data_v0002_20211119 | | <strong>SPSS |