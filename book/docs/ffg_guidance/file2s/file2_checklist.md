...
| | |
|:---:|---|
| 01 | Include STUDY_ID in each File 2 (the same for each individual as used in File 1) | 
...
| 03 | Ensure the file does not contain direct identifiers such as name or postcode. Some indirect identifiers and pseudo-identifiers can be included, because they have strong research utility (e.g. gender, ethnicity, age). LPS should ensure that these are processed to their local disclosure control standards. |
