...
> **An example File 2 with .csv data and metadata files can be downloaded from [here](../downloads/download_intro.md#file-2-downloads).**  
...
<big>**Table 4: File 2 attribute data .csv specification - only relevant if you do not store data in STATA or SPSS files.**</big>  
...
<big>**Table 5: File 2 variable label .csv specification - only relevant if you do not store data in STATA or SPSS files.**</big>
...
<big>**Table 6: File 2 value label .csv specification - only relevant if you do not store data in STATA or SPSS files.**</big> 
|Field Name | Data Type | Description |
|---|---|---|
| Dataset_Name | varchar(50) | The full and exact name you give the File 2 (see '[File 2 naming conventions](../file2s/file2_naming.md)') but do not include the file type postscript (e.g. do not include the .csv element). |
| Variable_Name | varchar(50) | The full and exact name that you use in your documentation for every variable included in the dataset. |
