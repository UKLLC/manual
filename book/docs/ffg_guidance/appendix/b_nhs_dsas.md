...
We advise you not to send NHS England supplied NHS IDs in your File 1s until you have checked that your DSA permits this use. If it doesn't you **must** contact NHS England to amend your DSA – see suggested wording below:  

><i>"Our Longitudinal Population Study (LPS) is part of the UK Longitudinal Linkage Collaboration (UK LLC). This provides us with a route to access linked NHS England records, the mechanism for which is supported by the UK LLC Data Sharing Agreement. We will use participants' NHS IDs as provided through this linkage to the NHS Patient Register and supported by this DSA to facilitate our linkage to NHS England records via UK LLC. To do this, we will provide NHS IDs along with wider patient identifiers to UK LLC's NHS trusted linkage third party. In turn, they will provide them to NHS England to establish their link. Using NHS IDs in this way will help ensure accuracy and consistency."</i>

**If you have any questions about NHS IDs, please contact [info@ukllc.ac.uk](mailto:info@ukllc.ac.uk)**