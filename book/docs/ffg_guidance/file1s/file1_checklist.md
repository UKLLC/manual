...
More information about this is provided in <span style = "color:red"><strong>Appendix B</strong>.
</details>
...
However, if there are NO changes to the content of a File 1, then there is NO requirement to send a File 1, but please email support@ukllc.ac.uk to confirm this.
</details>
...
* Make sure to retain a 'Current Row' with a STUDY_ID for ALL participants ever included in UK LLC. Where a participant’s status has changed, please create a new row marked 'C' (current) and change the 'row_status' on the old record to 'H' (historical). For more details refer to <span style = "color:red">Section 2.1</span>.  
...
<details>
<summary>7. Adhere exactly to the File 1 specification detailed below.
</summary>  

[File 1 specification](../file1s/file1_spec.md) 
</details>
...
Where:  
* UK LLC Study Code: <span style="color:red">See Appendix C
...
<details><summary>9. Retain all variables and use the exact variable names, in the same order as <span style="color:red">Table 3</span>.</summary>  
Do this even when data are absent for some variables. This is critical for the linkage process.</details>  
...
<details><summary>11. Send the correctly formatted attribute data to NHS DHCW following the process sent out in 1 above</summary>  

* Make sure to double check the date format to avoid inconsistent formats and follow the specifications in <span style="color:red">Section 2.1  
* <span style="color:teal"><strong>DO NOT SEND THE FILE 1 TO ANY OTHER ORGANISATION</span></strong>
</details>

<details><summary>12. Send the 'File 1 checker' output (File1_doc.json) to the UK LLC Data Team (support@ukllc.ac.uk)</summary>  
...
<details><summary>13. Retail a copy of each File 1 for potential audit purposes</summary>
</details>
