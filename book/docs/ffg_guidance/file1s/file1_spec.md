...
When an updated File 1 is provided, this should be built using the information that is current at the time – i.e. any new information, such as a new address, will be added to the 'current' row, and old information will be relegated to the 'historical' row(s) – see example in Table 2.
...
## Place-based data
There are four place-based permission flags that specify if the LPS approves the following linkages:  
...
<aside class="admonition note"><p class="admonition-title">Please refer to the <b>File 1 formatting table</b>, for detailed information about each variable to be included in each File 1.</p>

You MUST use the Field Names in the [File 1 formatting table](../file1s/file1_format_table.md) and Field Names MUST have underscores between words.</aside>
