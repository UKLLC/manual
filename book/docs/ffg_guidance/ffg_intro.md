...
This section of the <span style="color:red">LPS manual</span> explains:
...
A full explanation of this 'split-file' process and UK LLC data flows is in [**Appendix A**](../ffg_guidance/appendix/a_data_flows.md).  
